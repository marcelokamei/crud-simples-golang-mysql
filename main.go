...
//variável para renderizar todos os templates da pasta 'tmpl'
...
func main() {
	...
	//exibe mensagem indicando que o servidor foi iniciado
	log.Println("O servidor foi iniciado em: http://localhost:3306")
	...
	//iniciar servidor na porta 3306
